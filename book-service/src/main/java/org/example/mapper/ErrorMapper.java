...
public interface ErrorMapper {
    ...
    /**
     * Maps {@link BookNotFoundException} to a {@link ErrorResponse} DTO.
     *
    ...
    /**
     * Maps {@link BookAlreadyExistsException} to a {@link ErrorResponse} DTO.
     *
     * @param e thrown exception
     * @return {@link ErrorResponse} object
     */
    default ErrorResponse toErrorResponse(BookAlreadyExistsException e) {
        ErrorResponse errResp = new ErrorResponse();
        errResp.setStatus(HttpStatus.CONFLICT.value());
        errResp.setMessage(e.getMessage());
        return errResp;
    }
